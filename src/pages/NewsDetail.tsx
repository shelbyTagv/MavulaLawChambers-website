...
export default function NewsDetail() {
  ...
  if (!article) {
    return (
      <>
        <Seo title="Article Not Found | Mavula & Co. Law Chambers" description="The requested article could not be found." path={id ? `/news/${id}` : "/news"} />
  ...
  return (
    <>
      <Seo
        title={`${article.title} | Mavula & Co. Law Chambers`}
